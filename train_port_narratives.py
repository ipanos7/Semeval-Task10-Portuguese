...
def train_with_repeated_kfold_and_save(texts, labels):
    ...
    rskf = RepeatedStratifiedKFold(n_splits=5, n_repeats=2, random_state=42)  # Adjusted for smaller runs
    ...
    final_output_dir = "/content/drive/MyDrive/upd_narrative_model"
    model.save_pretrained(final_output_dir)
    tokenizer.save_pretrained(final_output_dir)
    print(f"Final model and tokenizer saved to {final_output_dir}.")
