...
def main():
    ...
    # Paths
    raw_data_folder = os.path.join(current_dir, "data", "portuguese_raw-documents")
    ...
    all_labels_file = os.path.join(current_dir, "data", "portuguese_all_labels.json")
    processed_annotations_file = os.path.join(current_dir, "data", "portuguese_processed_annotations.json")
    training_dataset_file = os.path.join(current_dir, "data", "portuguese_training_dataset.json")
