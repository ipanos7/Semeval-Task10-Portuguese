...
# Load models
narrative_model = AutoModelForSequenceClassification.from_pretrained("/content/drive/MyDrive/upd_narrative_model")
narrative_tokenizer = AutoTokenizer.from_pretrained("/content/drive/MyDrive/upd_narrative_model")
subnarrative_model = AutoModelForSequenceClassification.from_pretrained("/content/drive/MyDrive/upd_portuguese_subnarrative_model")
subnarrative_tokenizer = AutoTokenizer.from_pretrained("/content/drive/MyDrive/upd_portuguese_subnarrative_model")

# Load all labels
with open("/content/Semeval-Task10-Portuguese/data/portuguese_all_labels.json", "r") as f:
...
# Load test set
test_path = "/content/Semeval-Task10-Portuguese/data/test_port_subtask-2-documents"
texts = []
article_ids = []
...
with open("port_off_submission.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(submission))
